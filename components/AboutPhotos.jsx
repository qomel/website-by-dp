...
function RevealPhoto({ src, alt, width, height, style, from = 'left' }) {
  ...
  useEffect(() => {
    ...
    const io = new IntersectionObserver(
      ([entry]) => { if (entry.isIntersecting) { el.classList.add('about-photo-visible'); io.disconnect() } },
      { threshold: 0.1 }
    )
    io.observe(el)
...
export default function AboutPhotos() {
  return (
    <div style={{
      ...
      <RevealPhoto
        src="/mandarynka.jpg" alt="Mandarynka" width={330} height={440} from="right"
